...
let context = canvas.getContext("2d"); // Changed "2nd" to "2d"
...
let events = {
    mouse: {
        down: "mousedown",
        move: "mousemove", // Added a comma here
        up: "mouseup",
    },
    touch: {
        down: "touchstart",
        move: "touchmove", // Added a comma here
        up: "touchend",
    },
};
...
function startFireWork() {
    ...
    if (clicked) {
        createFirework(); // Fixed typo: changed "createdFirework" to "createFirework"
    }
